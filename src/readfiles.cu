...
extern string INNERBOUNDARY;
extern string LABELADVECTION;
extern string TRANSPORT;
extern string PLANETCONFIG;
extern float MASSTAPER;
extern string RADIALSPACING;
extern int NRAD;
extern int NSEC;
extern float RMIN;
extern float RMAX;
extern float THICKNESSSMOOTHING;
extern float ROCHESMOOTHING;
extern float ASPECTRATIO;
extern float VISCOSITY;
extern float ALPHAVISCOSITY;
extern float SIGMASLOPE;
extern float RELEASERADIUS;
extern float RELEASEDATE;
extern float OMEGAFRAME;
extern string DISK;
extern string FRAME;
extern string OUTERSOURCEMASS;
extern string WRITEDENSITY;
extern string WRITEVELOCITY;
extern string WRITEENERGY;
extern string WRITETEMPERATURE;
extern string WRITEDIVV;
extern string WRITEQPLUS;
extern string INDIRECTTERM;
extern string EXCLUDEHILL;
extern float IMPOSEDDISKDRIFT;
extern float FLARINGINDEX;
extern float ECCENTRICITY;
extern float CAVITYRADIUS;
extern float CAVITYRATIO;
extern float CAVITYWIDTH;
extern float TRANSITIONRADIUS;
extern float TRANSITIONRATIO;
extern float TRANSITIONWIDTH;
extern float LAMBDADOUBLING;
extern string SELFGRAVITY;
extern string CICPLANET;
extern string FORCEDCIRCULAR;
extern string ZMPLUS;
extern string ADIABATIC;
extern float ADIABATICINDEX;
extern string COOLING;
extern float COOLINGTIME0;

extern float G;
extern float PI;
int ExcludeHill, ViscosityAlpha, RocheSmoothing;
int OpenInner, AdvecteLabel, LogGrid;
