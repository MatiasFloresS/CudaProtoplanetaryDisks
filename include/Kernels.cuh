...
__global__ void Substep2Kernel (double *Dens, double *VradInt, double *VthetaInt, double *TemperInt,
  int nrad, int nsec, double CVNR, double *invdiffRmed, double *invdiffRsup, double *DensInt, int Adiabaticc,
...
__global__ void ViscousTermsKernel (double *Vradial, double *Vazimutal , double *DRR, double *DPP, double *DivergenceVelocity, double *DRP,
  double *invdiffRsup, double *invRmed, double *Rsup, double *Rinf, double *invdiffRmed, int nrad, int nsec,
  double *TAURR, double *TAUPP, double *Dens, double *viscosity_array, double *TAURP, double *invRinf);
