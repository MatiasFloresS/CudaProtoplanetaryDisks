...
rho0 =   fromfile(data_dir + "gasdens/"+ "gasdens{0:d}.raw".format(0),dtype='float32')         #1D array
#temp0 = fromfile(data_dir + "gasTemperature{0:d}.raw".format(0),dtype='float64')         #1D array
rho =   fromfile(data_dir + "gasdens/"+ "gasdens{0:d}.raw".format(output),dtype='float32')         #1D array
...
vrad =  fromfile(data_dir + "gasvrad/"+ "gasvrad{0:d}.raw".format(output),dtype='float32') #1D array
vtheta= fromfile(data_dir + "gasvtheta/"+ "gasvtheta{0:d}.raw".format(output),dtype='float32') #1D array
...
# figure(figsize=(15,5))
# rho1D = fromfile(data_dir + "/gasdens{0:d}.raw".format(output)).reshape(nrad,nsec).mean(axis=1)
...
# figure(figsize=(15,5))
# for i in range(5):
#     Rho = fromfile(data_dir + "/gasdens{0:d}.raw".format(i)).reshape(nrad,nsec).mean(axis=1)
...
figure(100)
imshow(log10(Rho),origin='lower',cmap=cm.Oranges_r,aspect='auto')
