...
test1 = "/home/matias/Desktop/CudaProtoplanetaryDisk/out/"
...
rho0 =   fromfile(data_dir + "gasdens{0:d}.dat".format(0),dtype='float32')         #1D array
#temp0 = fromfile(data_dir + "gasTemperature{0:d}.dat".format(0),dtype='float64')         #1D array
rho =   fromfile(data_dir + "gasdens{0:d}.dat".format(output),dtype='float64')         #1D array
#temp =  fromfile(data_dir + "gasTemperature{0:d}.dat".format(output),dtype='float64') #1D array
#qplus = fromfile(data_dir + "gasQplus{0:d}.dat".format(output),dtype='float64') #1D array
vrad =  fromfile(data_dir + "gasvrad{0:d}.dat".format(output),dtype='float64') #1D array
vtheta= fromfile(data_dir + "gasvtheta{0:d}.dat".format(output),dtype='float64') #1D array
